...
exports.subirImgen = (req, res, next) =>{
...
exports.formCrearCuenta=(req,res) =>{
    res.render('crear-cuenta',{ //creo que de views
...
exports.validarRegistro = (req, res, next) =>{
    ...
    req.checkBody('repetir', 'Confirmar password no puede ir vacio').notEmpty();
...
exports.formEditarPerfil = (req,res) =>{
    res.render('editar-perfil',{
        ...
        usuario: req.user, //para que los datos del usuario aparezcan en las cajas de texto
                            //con el apoyo del poner value={{usuario.nombre}}
        cerrarSesion: true,
